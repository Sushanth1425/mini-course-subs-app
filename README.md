...
A production-style full-stack MERN application that simulates an online learning platform where users can explore courses and subscribe using a promo-based payment flow.

  

The project demonstrates authentication, backend business logic, protected routes, API testing, CI/CD automation, and deployment.
...
git clone https://github.com/Sushanth1425/mini-course-subs-app.git
